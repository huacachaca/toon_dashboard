...
Each scenario shows: panel count, installed kWp, expected annual yield, and coverage %. Forecast solar advice reports these values separately for each August-to-July contract year rather than averaging the two years together.
